...
Route::group(['middleware' => ['auth']], function () {
    ...
    Route::get('get-wishlist', 'UserWishListController@getWishlist')->name('getWishlist');
    Route::get('my-Wishlist', 'UserWishListController@myWishlist')->name('my-Wishlist');
    // Route::get('/get-wishlist-items', 'WishlistController@getWishlistItems')->name('get.wishlist.items');
...
Route::post('get-all-subcategories', 'CategoriesController@getAllCategories');
...
Route::get('/loginview', 'Homecontroller@userdashboard');
