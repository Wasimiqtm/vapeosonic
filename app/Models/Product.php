...
class Product extends Model
{
   ...
   protected $hidden = [
    ...
    protected $fillable = [
        'name', 'product_id', 'code', 'ean_number', 'sku', 'shipping_id', 'brand_id', 'supplier_id', 'tax_rate_id', 'type', 'barcode_symbology', 'cost', 'price', 'is_variants', 'discount_type', 'discount', 'reward_points', 'number_of_packs', 'detail', 'invoice_detail', 'is_active','is_default','is_main_price','is_main_tax','full_detail','tecnical_specs','new_arrivals','is_featured','is_hot'
