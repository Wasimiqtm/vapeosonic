        ...
        <div class="row">
            <div class="col-md-12">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="banner-box">
                                                <div class="inner-box">
                                                    <a href="#" title="">
                                                        <img src="{{asset('front_assets/images/banner_boxes/submenu-01.png')}}" alt="">
                                                    </a>
                                                </div>
                                            </div>
                                        </div><!-- /.col-md-6 -->
                                        <div class="col-md-6">
                                            <div class="banner-box">
                                                <div class="inner-box">
                                                    <a href="#" title="">
                                                        <img src="{{asset('front_assets/images/banner_boxes/submenu-02.png')}}" alt="">
                                                    </a>
                                                </div>
                                            </div>
                                        </div><!-- /.col-md-6 -->
                ...
                <ul class="flat-infomation style1">
                    <li class="phone">
                        <img src="{{asset('front_assets/images/icons/call-3.png')}}" alt="">
