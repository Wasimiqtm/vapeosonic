...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en-US" lang="en-US"><!--<![endif]-->
    <head>
        ...
        <!-- sc -->
        <link rel="stylesheet" type="text/css" href="{{url('front_assets/sc.css/bootstrap.css')}}">

        <!-- Theme style -->
        <link rel="stylesheet" type="text/css" href="{{url('front_assets/stylesheets/style.css')}}">
        <!-- sc  -->
        <link rel="stylesheet" type="text/css" href="{{url('front_assets/sc.css/main.css')}}">
        ...
        <!-- sc css -->
        <link rel="stylesheet" type="text/css" href="{{url('front_assets/sc.css/responsive.css')}}">
        <link rel="stylesheet" type="text/css" href="{{url('front_assets/sc.css/main.css')}}">
    ...
    <body class="header_sticky {{@$class}}">
        ...
        <!-- sc script -->
        <script type="text/javascript" src="{{url('front_assets/sc.js/jquery.main.js')}}"></script>
        <script type="text/javascript" src="{{url('front_assets/sc.js/jquery.js')}}"></script>
        <script type="text/javascript" src="{{url('front_assets/sc.js/plugins.js')}}"></script>
