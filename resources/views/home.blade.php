						...
						<div class="row">
							<div class="col-xs-12">
								<ul id="product-filter">
									...
									<li class="active"  data-param="all"><a href="#">AlL</a></li>
									@foreach($categories as $category)
									<li><a href="#"    data-filter=".fil{{$category->id}}">{{$category->name}}</a></li>
									@endforeach
									<li class="left"><a href="#" id="product-shuffle"><i class="fa fa-random" aria-hidden="true"></i> shuffle</a></li>
								
								</ul>
								<ul class="masonry-list"  style="position: relative; height: 1046.3px;">
									@foreach($subCategories as $category)
									   
									<li class="fil{{$category->parent_id}}">

										<!-- mt product start here -->
										<div class="mt-product1 large">
											<!-- box start here -->
											<div class="box">
												<a href="{{url('products?category='.$category->id.'-'.string_replace($category->name).'&view-type=grid')}}">
